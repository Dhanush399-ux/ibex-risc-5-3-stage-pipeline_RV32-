...
module ibex_load_store_unit (
  ...
  always @(data_type_ex_i, handle_misaligned_q, data_addr) begin
  ...
  always @(wdata_offset, data_wdata_ex_i) begin
    case (wdata_offset)
  ...
  // FSM
  always @(data_err_i, data_gnt_i, data_pmp_err_i, data_req_ex_i, data_rvalid_i, data_we_q,
           handle_misaligned_q, ls_fsm_cs, lsu_err_q, pmp_err_q, split_misaligned_access)
  begin
    ls_fsm_ns       = ls_fsm_cs;
